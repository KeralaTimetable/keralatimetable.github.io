const masterQuestionPool = [
    ...
    },
    {
        ...
        "o": [
            ...
            "A physical notebook     3 | Page    d) A banking system"
        ],
        "a": "B"
    },
    {
    ...
    {
        "q": "1   Which of the following are the benefits of employing Blockchain in financial  transactions?    A. Faster Transactions   B. Error-Free Transactions     4 | Page     C. Centralized Verification",
        "o": [
            "A and B",
            "B and C",
            "A and C"
    ...
    {
        "q": "4   In financial services, Blockchain technology is used for:",
        "o": [
            "Automation",
            "Digital Connection",
            "Digital Instrument s"
        ],
        "a": "C"
    },
    {
    ...
    {
        "q": "Which type of analytics ensures that the path is predicted for the future  course of action?     5 | Page",
        "o": [
            "Predictive Analytics",
            "Prescriptive Analytics",
            "Diagnostic Analytics"
    ...
    {
        "q": "Which of the following AI frameworks is being determined in the below  image     6 | Page",
        "o": [
            "Deep learning IO",
            "Neural networks",
            "Pytorch",
    ...
    {
        "q": "Arrange the following steps in the correct order for developing a Machine  Learning model:   1. Model Evaluation      9 | Page    2. Data Preprocessing   3. Model Training",
        "o": [
            "2 > 3 > 1",
            "2 > 1 > 3",
            "1 > 3 > 2",
    ...
    {
        "q": "Which stage of the machine learning process is shown in the image?            12 | Page",
        "o": [
            "Model Training",
            "Data Collection",
            "Model Evaluation",
    ...
    {
        "q": "Identify the following Learning from ML :         13 | Page",
        "o": [
            "Supervise d",
            "Unsupervised",
            "Reinforcem ent",
    ...
    {
        "q": "Arrange the following steps in correct order to train a deep learning model using  supervised learning:     14 | Page    1. Evaluation of Model performance   2. Backpropagation to Update Weights   3. Initialization of Model Parameters",
        "o": [
            "2 > 3 > 1",
            "1 > 3 > 2",
            "3 > 2 > 1",
    ...
    {
        "q": "Arrange the following steps in order to describe how ChatGPT processes a user query:   1. Interpret the user query and identify the intent.   2. Retrieve relevant information from its training data.   3. Generate a response based on the identified intent and available data.       16 | Page",
        "o": [
            "3 > 2 > 1",
            "2 > 1 > 3",
            "1 > 3 > 2",
    ...
    {
        "q": "Identify the following chat bot:           17 | Page",
        "o": [
            "BING AI",
            "CLAUDE",
            "GEMINI",
    ...
    {
        "q": "Unsupervised Machine Learning algorithms are used when the information used to train  is neither classified nor labelled.       19 | Page",
        "o": [
            "True",
            "False"
        ],
    ...
    },
    {
        ...
        "o": [
            "Unsupervised Learning Algorith ms",
    ...
    },
    {
        ...
        "o": [
            ...
            "National Artificial Intelligence Strategy     22 | Page",
    ...
    },
    {
        ...
        "o": [
            ...
            "Chatbots are being used by HR to support training activities.     6 | Page",
    ...
    },
    {
        ...
        "o": [
            "Insufficient training data     4 | Page",
    ...
    },
    {
        ...
        "o": [
            "To generate images without any 3D objects     9 | Page",
    ...
    },
    {
        ...
        "o": [
            ...
            "DALL-E 2 is faster than DALL -E 1 at generating images.     10 | Page",
    ...
    {
        "q": "of the following is NOT among the 5Ds of Digital Marketing?",
        "o": [
            "Digital Platform",
            "Digital Systems",
            "Digital Data",
    ...
    {
        "q": "1   Which is the first stage involved in 3D Printing?",
        "o": [
    ...
    },
    {
        ...
        "o": [
            ...
            "Connected Design and Production, Manufacturing Software and Connected Value  Chain (   d) RPA Production, Connected Smart Factory and Connected Management Software"
        ],
        "a": "A"
    },
    {
    ...
    },
    {
        ...
        "o": [
            "Polymer 3D Printing will dominat e",
            "",
            "",
            ""
        ],
    ...
    {
        "q": "What is the name of the firs t VR headset invented by Ivan Sutherland?",
        "o": [
    ...
    {
        "q": "Which type of visualization chart is represented in the image? [Pie chart image]",
        "o": [
            "Line chart",
            "Scatter plot",
            "Pie chart",
    ...
    {
        "q": "What type of AI model architecture is depicted in the image ?         14 | Page",
        "o": [
    ...
    {
        "q": "8   What technological advancement contributed significantly to the resurgence of neural  networks in recent years?",
        "o": [
    ...
    },
    {
        ...
        "o": [
            ...
            "By simulating exams designed for humans like LSA T    18 | Page",
    ...
    },
    {
        ...
        "o": [
            ...
            "The most common type of PoS machine is a Debit or Credit card swiping machine  which allows customers to pay after typing in a PIN     6 | Page",
    ...
    {
        "q": "5   What type of cybercrime is described as potentially becoming more financially  damaging due to deepfakes?",
        "o": [
            "Ransomware attacks",
    ...
    {
        "q": "Which Cloud programming language is known for its reusability and modular approach  which mak es writing codes easy?",
        "o": [
            "Python",
            "Java",
            "Ruby"
    ...
    },
    {
        ...
        "o": [
            ...
            "Microsoft Cloud Monitoring     6 | Page",
            "Amazon Cloud Watch"
        ],
        "a": "A"
    },
